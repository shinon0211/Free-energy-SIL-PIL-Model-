...
plt.plot(fc_values, data_Sigma["F/Np_value"], label='Sigma Phase', color='blue')
plt.plot(fc_values, data_C14["F/Np_value"], label='C14 Phase', color='mediumslateblue')
plt.plot(fc_values, data_C15["F/Np_value"], label='C15 Phase', color='green')
plt.plot(fc_values, data_BCC["F/Np_value"], label='BCC Phase', color='red')
plt.xlabel('fc')
